...
{
	function scWidget(){
		$widget_ops = array('classname' => 'widget_hello_world', 'description' => __( "This widget allows you to easily add icons and links to your social network pages. Best used in the footer areas.") );
	...
	function widget($args, $instance){
		...
		$facebook = empty($instance['facebook']) ? 'scrybes' : $instance['facebook'];
		$twitter = empty($instance['twitter']) ? 'scrybes' : $instance['twitter'];
                $googleplus = empty($instance['googleplus']) ? 'http://gplus.to/scryb.es' : $instance['googleplus'];
		$rss = empty($instance['rss']) ? 'scrybes' : $instance['rss'];
		...
		echo '
<div>
        <a target="_blank" href="http://twitter.com/'.$twitter.'" id="followTwitter"><img src="'.get_bloginfo('url').'/wp-content/plugins/social-connect-widget/img/twitter.png" class="scwLogos" alt="Twitter" /></a> 

        <a target="_blank" href="http://www.facebook.com/'.$facebook.'" id="followFacebook"><img src="'.get_bloginfo('url').'/wp-content/plugins/social-connect-widget/img/facebook.png" class="scwLogos" alt="Facebook" /></a> 

        <a target="_blank" href="'.$googleplus.'" id="followGooglePlus"><img src="'.get_bloginfo('url').'/wp-content/plugins/social-connect-widget/img/googleplus.png" class="scwLogos" alt="Google+" /></a>
 
        <a target="_blank" href="http://feeds.feedburner.com/'.$rss.'" id="subscribeRSS"><img src="'.get_bloginfo('url').'/wp-content/plugins/social-connect-widget/img/rss.png" class="scwLogos" alt="RSS"/></a>
</div>
';		
		echo $after_widget;
	}
	...
	function form($instance){
		$instance = wp_parse_args( (array) $instance, array('facebook'=>'scrybes', 'twitter'=>'scrybes', 'googleplus'=>'scrybes', 'rss'=>'scrybes') );		
